...
add_action('init', function () {
    ...
    if ($IntershieldAdminOptions->intershield_settings['auto_update_bad_ip_switch'] === 'on') {
        ...
        $IntershieldUpdateBadIpList = new IntershieldUpdateBadIpList($IntershieldAdminOptions);
    } else {
    ...
    $IntershieldCheckIpStatus = new IntershieldCheckIpStatus($IntershieldAdminOptions->getBadIpListDb());
...
function intershield_uninstall()
{
    ...
    delete_option('intershield_bad_ip_list');
